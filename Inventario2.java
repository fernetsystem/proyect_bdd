...
public class Inventario2 extends Connect implements ActionListener{
	JFrame f;
	JLabel l1,bak;
	JTextField text1;
    ...
    f = new JFrame("INVENTARIO SUCURSAL 2");
	...
	try{
		String query="Select * from prendas_sucursal2 where codigo like '%"+palabra+"%' or nombre like '%"+palabra+"%' or descripcion like '%"+palabra+"%' or color like '%"+palabra+"%' or depto like '%"+palabra+"%' or existencia like '%"+palabra+"%' or precio like '%"+palabra+"%'"; 
    ...
    public static void main(String args[]){
    	Inventario2 ive = new Inventario2();
    	ive.use();
    }
}