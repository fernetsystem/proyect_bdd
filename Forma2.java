...
public class Forma2 extends JPanel implements ActionListener {
  ...
  public Forma2() {
    ...
    Icon icono_2 = new ImageIcon(getClass().getResource("icono12.png"));
	...
	public void usar1(){
    	...
    	b.add(btn1);	b.add(btn2);	b.add(btn3);
   		...
   		btn2.setText("Restaurar");	btn2.setBackground(new Color(49,74,82));		btn2.setForeground(Color.WHITE); 
    ...
    if(e.getSource() == btn1){
     ...
     if(e.getSource()==btn2){
     	...
     	try{
     		...
     		//File recupera = new File("C:\\appserv\\mysql\\bin",String.valueOf(Anombre)+".sql");
     		//FileWriter fw = new FileWriter(recupera);
     		Process proceso = runtime.exec("C:\\appserv\\mysql\\bin\\mysqldump -u root -p 12345678 nueva1 <"+Anombre);
