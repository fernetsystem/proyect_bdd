...
public class CompALogis2 extends Connect implements ActionListener{
	JFrame f;
    ...
    f = new JFrame("COMPRAR A LOGISTICA SUCURSAL 2");
	...
	try{
		String query="insert into facturas values("+text2.getText()+",2,localtimestamp())";
  		stmt =conexion.prepareStatement(query);
    ...
    public static void main(String args[]){
    	CompALogis2 com = new CompALogis2();
    	com.use();
    }   
}